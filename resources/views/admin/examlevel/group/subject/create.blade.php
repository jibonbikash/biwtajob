        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            {!! Form::open(array('route' => ['examlevelgroupsubjects.store'] ,'method'=>'POST', 'files' => false)) !!}
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('examlevel_group_id',[],null,['class'=>'form-control examlevel_group_id','placeholder'=>'Select ','id'=>'examlevel_group_id']) !!}
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
