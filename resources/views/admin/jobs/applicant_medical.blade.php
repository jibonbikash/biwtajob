...
@section('content')
    <div class="row page-title align-items-center">
        <div class="col-md-3 col-xl-6">
            <h4 class="mb-1 mt-0">Applicant List(Medical)</h4>
        </div>
        <div class="col-md-9 col-xl-6 text-md-right">
            <div class="mt-4 mt-md-0">
                ...
                <a class="btn btn-info" href="{{ route('Applicantmedicalexport') }}??job_id={{ app('request')->input('job_id') }}"> <i data-feather="download" class="icon-dual text-white"></i> Export</a>
    ...
    <div class="row">
     ...
     {!! Form::open(['route' => array('Applicantmedical'), 'files' => false, 'method'=>'get']) !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Import Applicant List(Medical)</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    {!! Form::open(['route' => array('Applicantmedicalimport'), 'files' => true, 'method'=>'POST']) !!}
