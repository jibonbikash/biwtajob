...
@section('content')
    <div class="row page-title align-items-center">
        <div class="col-md-3 col-xl-6">
            <h4 class="mb-1 mt-0">Applicant List(Practical)</h4>
        </div>
        <div class="col-md-9 col-xl-6 text-md-right">
            <div class="mt-4 mt-md-0">
                ...
                <a class="btn btn-info" href="{{ route('Applicantpracticalexport') }}??job_id={{ app('request')->input('job_id') }}"> <i data-feather="download" class="icon-dual text-white"></i> Export</a>
    ...
    <div class="row">
     ...
     {!! Form::open(['route' => array('Applicantpractical'), 'files' => false, 'method'=>'get']) !!}
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Import Applicant List(Practical)</h5>
